...
]), (0, validator_middleware_1.validate)(product_validator_1.updateproductSchema), product_controller_1.update);
router.delete("/:id", (0, auth_middleware_1.authenticate)([enum_types_1.Role.ADMIN, enum_types_1.Role.SUPER_ADMIN]), (0, validator_middleware_1.validate)(product_validator_1.deleteproductSchema), product_controller_1.remove);
